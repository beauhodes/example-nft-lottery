...
describe("Lottery", function () {
    ...
    before(async function () {
        ...
        //TODO: change VRF to use mocks, not testnet
        this.coordinatorAddr = '0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B' //rinkeby: 0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B
        this.linkToken = '0x01BE23585060835E02B77ef475b0Cc51aA1e0709' //rinkeby: 0x01BE23585060835E02B77ef475b0Cc51aA1e0709
        this.keyHash = '0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311' //rinkeby: 0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311
    })
    ...
    it("lottery should deploy correctly and be owned by owner", async function () {
        this.lottery = await this.LotteryContract.deploy(this.currency.address, this.coordinatorAddr, this.linkToken, this.keyHash)
